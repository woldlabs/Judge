...
class JudgeApp(ctk.CTk):
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(cfg, text="CONFIGURATION", font=ctk.CTkFont(size=12, weight="bold")).pack(anchor="w", padx=8, pady=4)
        self.min_dur_var = ctk.DoubleVar(value=0.06)
        ctk.CTkLabel(cfg, text="Min event duration (s)", font=ctk.CTkFont(size=10)).pack(anchor="w", padx=8)
        ...
        ctk.CTkLabel(cfg, text="Cross-modal window (s)", font=ctk.CTkFont(size=10)).pack(anchor="w", padx=8, pady=(6,0))
        ...
        ctk.CTkLabel(filter_frame, text="Min score filter (post-run)", font=ctk.CTkFont(size=10)).pack(anchor="w", padx=8)
        ...
        self.min_score_label = ctk.CTkLabel(filter_frame, text="0.0", font=ctk.CTkFont(size=10))
